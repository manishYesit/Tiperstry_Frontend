            ...
            <>
              ...
              {user.user && user.user._id == profile._id && (
                <Typography variant="small" color="primary">
                  {user.user.referalLink ? (
                    user.user.referalLink
                  ) : (
                    <div>
                      <Link href="#" onClick={getReferal}>
                        Get referral link
                      </Link>
                      <Typography color="textSecondary" paragraph>
                        <b>
                          Invite Friends and Earn Crypto Together, 5% Passive
                          Dogecoin Earning for Each Referral{" "}
                        </b>
                      </Typography>
                    </div>
                  )}
      ...
      {profile && !profile.deactivated && !profile.isDeleted && (
        ...
        >
          ...
          <div style={{ textAlign: "left" }}>
            ...
            <div className={classes.dataview}>
              <p>
                <span className={classes.followercountview}>
            ...
            <Box display="flex" justifyContent="flex-end">
              <ButtonGroup style={{ maxWidth: "100%" }}>
                <Button
                  ...
                  disableFocusRipple
                  color="primary"
                  onClick={toggleVerifyChannelModal}
                >
                  {t("Youtube Channel")}
                </Button>
                <Button
                ...
                <Button
                  ...
                  disableElevation
                  disableFocusRipple
                  onClick={toggleVerifyDomainModal}
                  color="primary"
                >
                  {t("Website")}
                </Button>
